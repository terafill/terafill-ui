  ...
  return (
    <button className="cursor-pointer rounded-lg [border:none] overflow-hidden flex flex-row items-center justify-start">
      ...
      <div className="flex flex-col text-left px-[8px] py-[8px]">
        <label className="cursor-pointer relative text-xl tracking-[0.03em] font-bold w-[230px] h-[23px] shrink-0">{appName}</label>
        <label className="cursor-pointer relative text-base tracking-[0.03em] w-[230px] h-[23px] shrink-0">{userName}</label>
      </div>
    </button>
  );
};
