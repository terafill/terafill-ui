  ...
  const loadProfile = () => {
    ...
    .then(response=>{
      ...
      setUserProfile(prevState=>({
        ...prevState,
        profileImage: response.profile_image?`data:image/jpeg;base64,${response.profile_image}`:''
      }));
    })
    .catch(error=>{
      console.log(error);
      ...
      <div className="h-screen w-full flex flex-col justify-start items-stretch text-left">
        ...
        <div className="h-full w-full flex flex-row items-stretch" id="app-screen">
          ...
          <div className="flex flex-1 items-center justify-center" id="page-content-outer">
            ...
            >
              <div className="flex flex-1 flex-col items-center justify-center gap-2" id="profile-picture-section">
                {
                ...
                <Button label="Update Photo" buttonType="light" labelClassName="text-gray-700">
                  <input type="file" onChange={onFileChange} className="cursor-pointer absolute opacity-0"/>
                </Button>
                {/*<Button label="Remove Photo" buttonType="light" labelClassName="text-red-500"/>*/}
              </div>
              <div className="flex flex-1 flex-col justify-center items-stretch gap-10" id="profile-data-section">
                <span className="relative w-full flex flex-row justify-center gap-2" id="name">
                  <div className="relative w-full" id="first-name">
                    ...
                    <input
                      ...
                      placeholder="Jane"
                      onChange={ (e) =>{setUserProfileView(prevState => ({...prevState, firstName: e.target.value}))} }
                  ...
                  <div className="relative w-full"  id="last-name">
                    ...
                    <input
                      ...
                      onChange={ (e) =>{setUserProfileView(prevState => ({...prevState, lastName: e.target.value}))} }
                    />
                  </div>
                </span>
                ...
                <div className="relative flex">
                  ...
                  <input
                    ...
                    onChange={ (e) =>{setUserProfileView(prevState => ({...prevState, email: e.target.value}))} }
                    disabled
                ...
                <div className="relative flex">
                  ...
                  <input
                    ...
                    onChange={ (e) => {setUserProfileView(prevState => ({...prevState, phoneNo: e.target.value}))} }
                    title="Please enter phone no."
                  />
                </div>
                <div className="flex flex-1 flex-row justify-center items-center gap-4" id="form-button-group">
                  <Button
                  ...
                  <Button
                    ...
                    onClick={async ()=>{
                      updateProfile(userProfileView.firstName, userProfileView.lastName, userProfileView.phoneNo, file)
                      .then(response=>{
